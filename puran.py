...
user_attacks = {}
bot_token = '7511544510:AAExcng1fID5m3SCMrTzUDc7TWy4ytK3QIw'
...
def handle_start(message):
    ...
    bot.send_message(message.chat.id, "welcome to Puran ddos @PURAN_MAX_YT:", reply_markup=markup)
